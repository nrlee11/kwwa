$(function () {
  ...
  var device = function () {
    ...
    support.touch =
      browser.ios ||
      browser.android ||
      (document.ontouchstart !== undefined && document.ontouchstart !== null);
        ...
        : browser.opera
          ...
          : browser.safari
            ...
            : browser.ie
              ? "ie ie" + browser.ie
              : "other";
    var clsMobileSystem = browser.ios
      ? "ios"
      : browser.android
        ? "android"
        : "etc";
    var clsMobile = browser.mobile
      ? browser.app
        ? "ui-a ui-m"
        : "ui-m"
      : "ui-d";
  ...
  var $window = window.$window || $(window),
    ...
    $html =
      window.$html || $("html") || document.getElementsByTagName("html")[0],
    $body = $("body"),
    $header = $("#header"),
    $wrap = $("#wrap"),
    $main = $("#container"),
  ...
  includeHtml(function () {
    ...
    $("#header .rside .btn_primary_sm").on("click", function () {
      ...
      // else if (index === 1) {
      //   // 정수시설운영관리사 3급
      //   $("h1.logo span").text("정수시설운영관리사 3급 양성과정");
      // }
      else if (index === 1) {
        // 상수도관망시설운영관리사
